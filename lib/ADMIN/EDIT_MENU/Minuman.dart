...
class MinumanPageAdmin extends StatefulWidget {
  @override
  _MinumanPageAdminState createState() => _MinumanPageAdminState();
}

class _MinumanPageAdminState extends State<MinumanPageAdmin> {
  ...
  void _toggleItemSelection(int index) {
    setState(() {
      Map<String, dynamic> selectedItem = {
        ...
        'cloudImageurl': menuItems[index]['cloudImageUrl'],
        'quantity': 1,
      };
